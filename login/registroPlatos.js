...
var url_redi_remote = 'https://juanvaldemar.github.io/restaurantepimenton/login/publicar.html';
  ...
  function guardar(){
      ...
      db.collection("restaurantePlatos").add({ 
  ...
  db.collection("restaurantePlatos").onSnapshot((querySnapshot) => {
      tabla_.innerHTML = '';
...
function eliminar(id){
    db.collection("restaurantePlatos").doc(id).delete().then(function() {
...
function editar(id, titulo, sumilla, urlImagen){
    ...
    boton.onclick = function(){
        var washingtonRef = db.collection("restaurantePlatos").doc(id);
