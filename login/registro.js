 //configuración personal de Firebase
   ...
   var url_redi_remote = 'http://localhost/restaurantepimenton/login/publicar.html';
      ...
      function guardar(){
          ...
          db.collection("restauranteDesayunos").add({ 
      ...
      db.collection("restauranteDesayunos").onSnapshot((querySnapshot) => {
          tabla_.innerHTML = '';
    ...
    function eliminar(id){
        db.collection("restauranteDesayunos").doc(id).delete().then(function() {
    ...
    function editar(id, titulo, sumilla, urlImagen){
        ...
        boton.onclick = function(){
            var washingtonRef = db.collection("restauranteDesayunos").doc(id);
